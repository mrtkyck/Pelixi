...
set "MYNOTES_APP_DIR=%LOCALAPPDATA%\MyNotesDemo"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$env:MYNOTES_HOST='0.0.0.0'; $env:MYNOTES_PORT='8000'; $env:MYNOTES_APP_DIR=$env:LOCALAPPDATA + '\MyNotesDemo'; " ^
...
echo.
echo MyNotes DEMO veritabani ile yerel ag modunda baslatildi.
echo Kisisel verilerden ayri demo klasoru: %LOCALAPPDATA%\MyNotesDemo
